...
* **(R7h)**  *The CountLove project embodys multiple forms of challenging power as described in the chapter. For instance, in the category of "Collect", CountLove project gathers data about protest activities, data that may be overlooked or neglected by traditional institutions. In the "Analyze" part, project uses  data to highlight and examine societal trends which can illuminate inequities or injustices.*
* 
...
* 
* **(R7j)**  *CountLove project could involve temporal and geographic patterns in their data. In other words, they can analyze how protests flow and end over time in response to national or global events.*
